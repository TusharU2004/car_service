...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { 
    ...
    if ($bookingType === 'day') { 
        ...
        $insertQuery = "INSERT INTO booking_req (user_id, vehicle_id, start_date, end_date, start_time, end_time, days_booked, total_price, status, payment_way) 
                        VALUES ('$user_id', '$vehicle_id', '$start_date', '$end_date', '00:00:00', '23:59:59', '$days_booked', '$total_price', 'Pending','Razorpay')"; 
        ...
        $insertQuery = "INSERT INTO booking_req (user_id, vehicle_id, start_date, end_date, start_time, end_time, hours_booked, total_price, status, payment_way)
                        VALUES ('$user_id', '$vehicle_id', '$date', '$date', '$start_time', '$end_time', '$hours_booked', '$total_price', 'Pending', 'Razorpay')";
